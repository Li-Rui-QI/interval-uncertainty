...
class Plotter:
    ...
    def plotInputDatas(self, data, data2):
        ...
        plt.plot(data_n, [d[0]  for  d in data], 'C0', label='Ch1_700nm_2mm.csv')
        plt.legend()
        ...
        plt.plot(data_n, [ed[0] for ed in data2], 'C1', label='Ch2_700nm_2mm.csv')
        plt.legend()
        plt.title('Experiment data')
        plt.xlabel('n')
        plt.ylabel('mV')
        ...
        plt.plot(data_n, [data[i][0] for i in range(len(data))], label='Ch1_700nm_2mm.csv')
        plt.plot(data_n, [data2[i][0] for i in range(len(data2))], label='Ch2_700nm_2mm.csv')
        plt.legend()
